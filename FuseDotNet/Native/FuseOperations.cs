...
internal sealed class FuseOperations
{
    ...
    public delegate int fuse_f_rename(nint path, nint target, uint flags);
    public delegate int fuse_f_link(nint path, nint target);
    public delegate int fuse_f_chmod(nint path, PosixFileMode mode, ref FuseFileInfo fileInfo);
    public delegate int fuse_f_chown(nint path, int uid, int gid, ref FuseFileInfo fileInfo);
    public delegate int fuse_f_truncate(nint path, long size, ref FuseFileInfo fileInfo);
